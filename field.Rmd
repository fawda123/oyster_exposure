...
# pout
jpeg(here('figs/fieldcomp2.jpeg'), height = 6, width = 6.5, family = 'serif', units = 'in', res = 500)
print(p)
dev.off()
```
...
# pout
jpeg(here('figs/fieldcomp4.jpeg'), height = 7, width = 8.5, family = 'serif', units = 'in', res = 500)
print(p2)
dev.off()

# pout
jpeg(here('figs/fieldcomp5.jpeg'), height = 5, width = 8.5, family = 'serif', units = 'in', res = 500)
print(p3)
dev.off()
```
